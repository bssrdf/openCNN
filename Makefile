...
all:
	...
	nvcc src/openCNN_winograd_32Tx64x16.cu -Xptxas="-v" -lcudnn -m64 -arch=compute_$(ARCH) -code=sm_$(ARCH) -o $(NAME2) -D$(OUT)
	nvcc src/openCNN_winograd_32Tx64x8.cu -Xptxas="-v" -lcudnn -m64 -arch=compute_$(ARCH) -code=sm_$(ARCH) -o $(NAME4) -D$(OUT)
